...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.IntegerField(unique=True, validators=[django.core.validators.MinLengthValidator(11)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('remita', 'https://remita.net/'), ('paypal', 'http://paypal.com/'), ('stripe', 'http://stripe.com/'), ('mastercard', 'http://developers.mastercard.com/')], max_length=30)),
                ('gateway_link', models.CharField(blank=True, max_length=200)),
                ('user_id', models.CharField(blank=True, max_length=30, null=True)),
                ('secret_key', models.CharField(blank=True, max_length=300)),
                ('public_key', models.CharField(blank=True, max_length=300)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('facebook', 'Facebook'), ('twitter', 'Twitter'), ('instagram', 'Instagram'), ('craigslist', 'Craigslist')], max_length=15)),
            ],
        ),
        migrations.CreateModel(
            name='Store',
